...
export const PANEL_CSS = [
  ...
  '.notice p { margin: 0; }',
  /* The not-the-host warning: red rather than amber, because it is about what
     the button will refuse to do, not about a list being incomplete. */
  '.notice.warn { background: #3b1f1e; color: #f2b8b5; }',
  '.notice .why { margin-top: 4px; opacity: .75; font-size: 11px; }',
  '.notice .chip { margin-top: 8px; border-color: currentColor; color: inherit; }',
  '.notice .chip:hover { background: rgba(0,0,0,.3); color: inherit; }',
  '.notice .chip:disabled { opacity: .5; cursor: default; }',
  '.notice .chip:disabled:hover { background: none; }',
  '.section-head { margin: 10px 2px 2px; font-size: 11px; font-weight: 600;',
  '  letter-spacing: .04em; text-transform: uppercase; color: #9aa0a6; }',
  ...
  /* Hide, the guest's counterpart to Remove: same shape, quieter colours,
   * because it changes nothing for anyone else in the call. */
  '.secondary { flex: 1; background: none; border: 1px solid #444746; border-radius: 18px;',
  '  color: #e3e3e3; cursor: pointer; font: inherit; font-weight: 500; padding: 8px 12px; }',
  '.secondary:hover:not(:disabled) { background: #333537; }',
  '.secondary:disabled { border-color: #333537; color: #9aa0a6; cursor: default; }',
  '.secondary .beta { color: #a8c7fa; font-size: 8px; font-weight: 600; letter-spacing: .06em;',
  '  line-height: 0; margin-left: 3px; text-transform: uppercase; vertical-align: super; }',
